// Spines.Mahjong.LocalMatchViewer.Match.cs
// 
...
namespace Spines.Mahjong.LocalMatchViewer.Model
{
  internal class Match : IMatchClient
  {
    private readonly ISet<Tile> _hand = new HashSet<Tile>();
    ...
    {
      _hand.Remove(discardInformation.Tile);
    }
  }
}