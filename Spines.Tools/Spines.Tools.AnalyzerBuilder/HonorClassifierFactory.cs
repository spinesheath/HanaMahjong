...
{
  internal class HonorClassifierFactory
  {
    ...
    {
      var wordsFile = Path.Combine(_workingDirectory, "HonorWords.txt");
      ...
      var classifierFile = Path.Combine(_workingDirectory, "HonorClassifier.bin");
