...
function RenderContext(canvasName) {
    ...
    this._camera = this._createCamera(displayWidth, displayHeight);
...
RenderContext.prototype.createTiles = function (arrange) {
    ...
    if (this._tileGeometry === undefined) {
        Promise.all([this._getGeometryPromise("tile"), this._getGeometryPromise("ba")]).then(geometries => {
...
RenderContext.prototype._createCamera = function(width, height) {
...
RenderContext.prototype._getGeometryPromise = function(name) {
...
RenderContext.prototype._createMaterial = function() {
